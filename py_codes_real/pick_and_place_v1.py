...
class PickAndPlace(Node):
    def __init__(self, args, joint_state_topic='/franka/joint_states',
                 gripper_ns='/panda_gripper'):
        ...
        self.homing_client = ActionClient(self, Homing, f'{gripper_ns}/homing')
...
def main():
    ...
    gripper_ns = '/panda_gripper_sim_node' if args.sim else '/panda_gripper'

    rclpy.init()
    node = PickAndPlace(args, joint_state_topic, gripper_ns)
    try:
        node.run_sequence()
    finally:
        node.destroy_node()
